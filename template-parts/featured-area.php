...
<div id="featured" class="grid col-940">
	...
	<div id="featured-image" class="grid col-460 fit">
		...
		<?php $featured_content = ( !empty( $responsive_options['featured_content'] ) ) ? $responsive_options['featured_content'] : '<img class="aligncenter" src="' . get_stylesheet_directory_uri() . '/core/images/rdecojewelry-logo-md.png" width="440" height="300" alt="" />'; ?>
